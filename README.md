...
- `lib/raidTemplate.ts` : schéma canonique, création, normalisation et export
- `lib/templateFileIO.ts` : import/export JSON
- `app/players/page.tsx` : gestion du nombre et des informations des personnages
- `app/encounters/page.tsx` : visualisation et édition des encounters, équipements et skills
...
Le document principal est le template JSON exposé via `lib/raidTemplate.ts`, avec des structures comme :
